# process single-cell breast dataset from Bassez et al. 2021
...
exp <- ReadMtx(
  mtx = "../analyses/single-cell/input/Bassez2021/Exp_data_UMIcounts.mtx",
  cells = "../analyses/single-cell/input/Bassez2021/Cells.csv", 
  features = "../analyses/single-cell/input/Bassez2021/Genes.txt", 
  cell.column = 1, 
  cell.sep = ",",
  skip.cell = 1,
  feature.column = 1)
...
# metadata
meta <- read.csv(
  "../analyses/single-cell/input/Bassez2021/Meta-data.csv")

# annotation
ann <- read.csv(
  "../analyses/single-cell/input/Bassez2021/Cells.csv")


# metadata ----

# cancer sample
table(meta$sample_primary_met)
...
saveRDS(
  object = exp_pseudo, 
  file = "../analyses/single-cell/output/brca_bassez/exp_pseudobulk_all-cells.rds")
